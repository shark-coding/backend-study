...
public class EventCsvReader {
	...
	public List<NoDisturbance> readNoDisturbance(String path) throws IOException, CsvException{
	...
	public List<OutOfOffice> readOutOfOffice(String path) throws IOException, CsvException{
	...
	public List<Todo> readTodo(String path) throws IOException, CsvException{
